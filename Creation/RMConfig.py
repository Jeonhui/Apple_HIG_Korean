...
class RMConfig:
    def __init__(self):
        with open('configure.json', 'r') as c:
            ...
            self.to_main_path = configure[RMConfigKey.to_main_path.value]
            ...
            self.change_keyword2_key = configure[RMConfigKey.change_keyword2_key.value]
            ...
            self.base_file_join_key = configure[RMConfigKey.base_file_join_key.value]
            self.base_file_title = configure[RMConfigKey.base_file_title.value]
            self.base_file_subtitle = configure[RMConfigKey.base_file_subtitle.value]
            self.link = configure[RMConfigKey.link.value]
