| keyword | url | path | check |  
 | --- | --- | --- | ---- |  
 | Platforms | https://developer.apple.com/design/human-interface-guidelines/platforms | ./human-interface-guidelines-markdown/platforms.md |  |   
 | Designing for iOS | https://developer.apple.com/design/human-interface-guidelines/designing-for-ios | ./human-interface-guidelines-markdown/platforms/designing-for-ios.md |  |   
 | Designing for iPadOS | https://developer.apple.com/design/human-interface-guidelines/designing-for-ipados | ./human-interface-guidelines-markdown/platforms/designing-for-ipados.md |  |   
 | Designing for macOS | https://developer.apple.com/design/human-interface-guidelines/designing-for-macos | ./human-interface-guidelines-markdown/platforms/designing-for-macos.md |  |   
 | Designing for tvOS | https://developer.apple.com/design/human-interface-guidelines/designing-for-tvos | ./human-interface-guidelines-markdown/platforms/designing-for-tvos.md |  |   
 | Designing for visionOS | https://developer.apple.com/design/human-interface-guidelines/designing-for-visionos | ./human-interface-guidelines-markdown/platforms/designing-for-visionos.md |  |   
 | Designing for watchOS | https://developer.apple.com/design/human-interface-guidelines/designing-for-watchos | ./human-interface-guidelines-markdown/platforms/designing-for-watchos.md |  |   
 | Foundations | https://developer.apple.com/design/human-interface-guidelines/foundations | ./human-interface-guidelines-markdown/foundations.md |  |   
 | Accessibility | https://developer.apple.com/design/human-interface-guidelines/accessibility | ./human-interface-guidelines-markdown/foundations/accessibility.md |  |   
 | App icons | https://developer.apple.com/design/human-interface-guidelines/app-icons | ./human-interface-guidelines-markdown/foundations/app-icons.md |  |   
 | Branding | https://developer.apple.com/design/human-interface-guidelines/branding | ./human-interface-guidelines-markdown/foundations/branding.md |  |   
 | Color | https://developer.apple.com/design/human-interface-guidelines/color | ./human-interface-guidelines-markdown/foundations/color.md |  |   
 | Dark Mode | https://developer.apple.com/design/human-interface-guidelines/dark-mode | ./human-interface-guidelines-markdown/foundations/dark-mode.md |  |   
 | Icons | https://developer.apple.com/design/human-interface-guidelines/icons | ./human-interface-guidelines-markdown/foundations/icons.md |  |   
 | Images | https://developer.apple.com/design/human-interface-guidelines/images | ./human-interface-guidelines-markdown/foundations/images.md |  |   
 | Immersive experiences | https://developer.apple.com/design/human-interface-guidelines/immersive-experiences | ./human-interface-guidelines-markdown/foundations/immersive-experiences.md |  |   
 | Inclusion | https://developer.apple.com/design/human-interface-guidelines/inclusion | ./human-interface-guidelines-markdown/foundations/inclusion.md |  |   
 | Layout | https://developer.apple.com/design/human-interface-guidelines/layout | ./human-interface-guidelines-markdown/foundations/layout.md |  |   
 | Materials | https://developer.apple.com/design/human-interface-guidelines/materials | ./human-interface-guidelines-markdown/foundations/materials.md |  |   
 | Motion | https://developer.apple.com/design/human-interface-guidelines/motion | ./human-interface-guidelines-markdown/foundations/motion.md |  |   
 | Privacy | https://developer.apple.com/design/human-interface-guidelines/privacy | ./human-interface-guidelines-markdown/foundations/privacy.md |  |   
 | Right to left | https://developer.apple.com/design/human-interface-guidelines/right-to-left | ./human-interface-guidelines-markdown/foundations/right-to-left.md |  |   
 | SF Symbols | https://developer.apple.com/design/human-interface-guidelines/sf-symbols | ./human-interface-guidelines-markdown/foundations/sf-symbols.md |  |   
 | Spatial layout | https://developer.apple.com/design/human-interface-guidelines/spatial-layout | ./human-interface-guidelines-markdown/foundations/spatial-layout.md |  |   
 | Typography | https://developer.apple.com/design/human-interface-guidelines/typography | ./human-interface-guidelines-markdown/foundations/typography.md |  |   
 | Writing | https://developer.apple.com/design/human-interface-guidelines/writing | ./human-interface-guidelines-markdown/foundations/writing.md |  |   
 | Patterns | https://developer.apple.com/design/human-interface-guidelines/patterns | ./human-interface-guidelines-markdown/patterns.md |  |   
 | Charting data | https://developer.apple.com/design/human-interface-guidelines/charting-data | ./human-interface-guidelines-markdown/patterns/charting-data.md |  |   
 | Collaboration and sharing | https://developer.apple.com/design/human-interface-guidelines/collaboration-and-sharing | ./human-interface-guidelines-markdown/patterns/collaboration-and-sharing.md |  |   
 | Drag and drop | https://developer.apple.com/design/human-interface-guidelines/drag-and-drop | ./human-interface-guidelines-markdown/patterns/drag-and-drop.md |  |   
 | Entering data | https://developer.apple.com/design/human-interface-guidelines/entering-data | ./human-interface-guidelines-markdown/patterns/entering-data.md |  |   
 | Feedback | https://developer.apple.com/design/human-interface-guidelines/feedback | ./human-interface-guidelines-markdown/patterns/feedback.md |  |   
 | File management | https://developer.apple.com/design/human-interface-guidelines/file-management | ./human-interface-guidelines-markdown/patterns/file-management.md |  |   
 | Going full screen | https://developer.apple.com/design/human-interface-guidelines/going-full-screen | ./human-interface-guidelines-markdown/patterns/going-full-screen.md |  |   
 | Launching | https://developer.apple.com/design/human-interface-guidelines/launching | ./human-interface-guidelines-markdown/patterns/launching.md |  |   
 | Live-viewing apps | https://developer.apple.com/design/human-interface-guidelines/live-viewing-apps | ./human-interface-guidelines-markdown/patterns/live-viewing-apps.md |  |   
 ...
 | Menus and actions | https://developer.apple.com/design/human-interface-guidelines/menus-and-actions | ./human-interface-guidelines-markdown/components/menus-and-actions.md |  |   
 ...
 | Segmented Controls | https://developer.apple.com/design/human-interface-guidelines/segmented-controls | ./human-interface-guidelines-markdown/components/selection-and-input/segmented-controls.md |  |   
